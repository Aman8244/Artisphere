...
import FetchFavourite from '@/helpers/fetchFavourite'
                                            ...
                                            {data.favItems.map((item, key) => {
                                                return <Card key={key} className='mx-1 p-0'>
                                                    <CardHeader className='flex flex-row'>
                                                        ...
                                                        <Button onClick={() => RemoveFavourite(item.artName)} className='bg-transparent p-0 mx-4'>
                                                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="35" height="25" viewBox="0 0 100 100">
