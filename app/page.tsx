    ...
    <main className="background-black">
      ...
      <section className=" flex justify-center items-center sm:h-[520px]">
        <div className="sm:flex sm:flex-row">
          <div className="flex justify-center sm:px-20 flex-col sm:w-3/5">
            <div className="text-white sm:text-[3rem] font-serif uppercase">
              Artisphere
            </div>
            ...
            <div>
              <Button className="bg-purple-700 px-4 sm:mt-8 hover:bg-purple-500 text-white" asChild>
                <Link href={"/dashboard"}>
                  Explore
                </Link>
              </Button>
